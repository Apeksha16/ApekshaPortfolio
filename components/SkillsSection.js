...
const SkillsSection = () => {
  ...
  const row1 = skills.slice(0, 5); // First 7 icons
  const row2 = skills.slice(5, 9); // Next 6 icons
  const row3 = skills.slice(9, 14); // Last 7 icons
  ...
  return (
    <section id="skills" className="bg-black text-white py-6">
      <div className="mx-auto px-6 md:px-8 lg:px-16">
        ...
        <SectionHeader title={'skills'} description={'Expert in Front End Development, & Software Development.'} linkText={''} link={''} />
